...
function updateDash(state) {
  ...
  d3.request("https://cancer-app-1.herokuapp.com/cancer_dash/").get(incomingData => {
    var incomingData = JSON.parse(incomingData.response);

    d3.request("https://cancer-app-1.herokuapp.com/cancer_mortality").get(incomingMortalityData => {
...
d3.request("https://cancer-app-1.herokuapp.com/cancer_dash/").get(data => {
